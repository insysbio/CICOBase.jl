...
[test_alg_interval(alg; bounds=(-1e10,1e10), scan_tol=1e-6, loss_grad=:AUTODIFF) for alg in grad_algorithms_autodiff]
...
[test_alg_interval(alg; bounds=(-1e10,1e10), scan_tol=1e-6, loss_grad=:FINITE) for alg in grad_algorithms_finite]
